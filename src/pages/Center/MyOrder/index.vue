                ...
                >
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <!-- 下面4个td分别表示收货人、金额、状态、操作 -->
                            <!-- 这儿的这4个td只用出现一次即可，所以用v-if结合外面包的v-if中的index来控制只显示一次 -->
                            <!-- td标签中的rowspan表示单元格可横跨的行数，而这儿的行数是由有几个商品决定的，所以
                            这儿为 :rowspan="order.orderDetailList.length"  -->
                            <td
